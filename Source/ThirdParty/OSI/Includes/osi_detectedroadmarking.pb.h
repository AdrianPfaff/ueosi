...
class DetectedRoadMarking_CandidateRoadMarking final :
 ...
 public:
  ...
  ~DetectedRoadMarking_CandidateRoadMarking() override;
  explicit PROTOBUF_CONSTEXPR DetectedRoadMarking_CandidateRoadMarking(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DetectedRoadMarking_CandidateRoadMarking* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const DetectedRoadMarking_CandidateRoadMarking& from) {
    DetectedRoadMarking_CandidateRoadMarking::MergeImpl(*this, from);
  }
  private:
  ...
  protected:
  explicit DetectedRoadMarking_CandidateRoadMarking(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
class DetectedRoadMarking final :
 ...
 public:
  ...
  ~DetectedRoadMarking() override;
  explicit PROTOBUF_CONSTEXPR DetectedRoadMarking(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DetectedRoadMarking* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const DetectedRoadMarking& from) {
    DetectedRoadMarking::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  protected:
  explicit DetectedRoadMarking(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
inline void DetectedRoadMarking_CandidateRoadMarking::unsafe_arena_set_allocated_classification(
    ::osi3::RoadMarking_Classification* classification) {
...
inline void DetectedRoadMarking::unsafe_arena_set_allocated_header(
    ::osi3::DetectedItemHeader* header) {
  if (GetArenaForAllocation() == nullptr) {
...
inline void DetectedRoadMarking::unsafe_arena_set_allocated_base(
    ::osi3::BaseStationary* base) {
  if (GetArenaForAllocation() == nullptr) {
...
inline void DetectedRoadMarking::unsafe_arena_set_allocated_base_rmse(
    ::osi3::BaseStationary* base_rmse) {
  if (GetArenaForAllocation() == nullptr) {
...
inline ::osi3::DetectedRoadMarking_CandidateRoadMarking* DetectedRoadMarking::add_candidate() {
  ::osi3::DetectedRoadMarking_CandidateRoadMarking* _add = _internal_add_candidate();
...
inline void DetectedRoadMarking::unsafe_arena_set_allocated_color_description(
    ::osi3::ColorDescription* color_description) {
  if (GetArenaForAllocation() == nullptr) {
