...
class DetectedOccupant_CandidateOccupant final :
 ...
 public:
  ...
  ~DetectedOccupant_CandidateOccupant() override;
  explicit PROTOBUF_CONSTEXPR DetectedOccupant_CandidateOccupant(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DetectedOccupant_CandidateOccupant* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const DetectedOccupant_CandidateOccupant& from) {
    DetectedOccupant_CandidateOccupant::MergeImpl(*this, from);
  }
  private:
...
class DetectedOccupant final :
 ...
 public:
  ...
  ~DetectedOccupant() override;
  explicit PROTOBUF_CONSTEXPR DetectedOccupant(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DetectedOccupant* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const DetectedOccupant& from) {
    DetectedOccupant::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
// optional double probability = 1;
inline bool DetectedOccupant_CandidateOccupant::_internal_has_probability() const {
...
inline ::osi3::DetectedOccupant_CandidateOccupant* DetectedOccupant::add_candidate() {
  ::osi3::DetectedOccupant_CandidateOccupant* _add = _internal_add_candidate();
