...
class SensorDataSeries final :
 ...
 public:
  ...
  ~SensorDataSeries() override;
  explicit PROTOBUF_CONSTEXPR SensorDataSeries(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SensorDataSeries* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const SensorDataSeries& from) {
    SensorDataSeries::MergeImpl(*this, from);
  }
  private:
  ...
  protected:
  explicit SensorDataSeries(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
class SensorDataSeriesList final :
 ...
 public:
  ...
  ~SensorDataSeriesList() override;
  explicit PROTOBUF_CONSTEXPR SensorDataSeriesList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SensorDataSeriesList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const SensorDataSeriesList& from) {
    SensorDataSeriesList::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  protected:
  explicit SensorDataSeriesList(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
inline int SensorDataSeries::_internal_sensor_data_size() const {
  return _impl_.sensor_data_.size();
}
...
inline ::osi3::SensorData* SensorDataSeries::mutable_sensor_data(int index) {
  ...
  return _impl_.sensor_data_.Mutable(index);
}
...
inline const ::osi3::SensorData& SensorDataSeries::_internal_sensor_data(int index) const {
  return _impl_.sensor_data_.Get(index);
}
...
inline ::osi3::SensorData* SensorDataSeries::_internal_add_sensor_data() {
  return _impl_.sensor_data_.Add();
}
inline ::osi3::SensorData* SensorDataSeries::add_sensor_data() {
  ::osi3::SensorData* _add = _internal_add_sensor_data();
...
inline ::osi3::SensorDataSeries* SensorDataSeriesList::add_sensor() {
  ::osi3::SensorDataSeries* _add = _internal_add_sensor();
