...
inline bool TrafficLight_Classification_Color_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TrafficLight_Classification_Color* value) {
...
inline bool TrafficLight_Classification_Icon_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TrafficLight_Classification_Icon* value) {
...
inline bool TrafficLight_Classification_Mode_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TrafficLight_Classification_Mode* value) {
...
class TrafficLight_Classification final :
 ...
 public:
  ...
  ~TrafficLight_Classification() override;
  explicit PROTOBUF_CONSTEXPR TrafficLight_Classification(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  TrafficLight_Classification* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const TrafficLight_Classification& from) {
    TrafficLight_Classification::MergeImpl(*this, from);
  }
  private:
  ...
  protected:
  explicit TrafficLight_Classification(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
class TrafficLight final :
 ...
 public:
  ...
  void unsafe_arena_set_allocated_classification(
      ::osi3::TrafficLight_Classification* classification);
...
inline const ::osi3::LogicalLaneAssignment& TrafficLight_Classification::_internal_logical_lane_assignment(int index) const {
...
inline ::osi3::LogicalLaneAssignment* TrafficLight_Classification::_internal_add_logical_lane_assignment() {
...
inline void TrafficLight::unsafe_arena_set_allocated_id(
    ::osi3::Identifier* id) {
...
inline void TrafficLight::unsafe_arena_set_allocated_base(
    ::osi3::BaseStationary* base) {
  if (GetArenaForAllocation() == nullptr) {
...
inline void TrafficLight::unsafe_arena_set_allocated_classification(
    ::osi3::TrafficLight_Classification* classification) {
  if (GetArenaForAllocation() == nullptr) {
...
inline ::osi3::TrafficLight_Classification* TrafficLight::_internal_mutable_classification() {
  ...
  if (_impl_.classification_ == nullptr) {
    auto* p = CreateMaybeMessage<::osi3::TrafficLight_Classification>(GetArenaForAllocation());
...
void TrafficLight::set_model_reference(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline void TrafficLight::unsafe_arena_set_allocated_color_description(
    ::osi3::ColorDescription* color_description) {
  if (GetArenaForAllocation() == nullptr) {
