...
class DetectedTrafficLight_CandidateTrafficLight final :
 ...
 public:
  ...
  ~DetectedTrafficLight_CandidateTrafficLight() override;
  explicit PROTOBUF_CONSTEXPR DetectedTrafficLight_CandidateTrafficLight(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DetectedTrafficLight_CandidateTrafficLight* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const DetectedTrafficLight_CandidateTrafficLight& from) {
    DetectedTrafficLight_CandidateTrafficLight::MergeImpl(*this, from);
  }
  private:
  ...
  protected:
  explicit DetectedTrafficLight_CandidateTrafficLight(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
class DetectedTrafficLight final :
 ...
 public:
  ...
  ~DetectedTrafficLight() override;
  explicit PROTOBUF_CONSTEXPR DetectedTrafficLight(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DetectedTrafficLight* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const DetectedTrafficLight& from) {
    DetectedTrafficLight::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  protected:
  explicit DetectedTrafficLight(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
inline void DetectedTrafficLight_CandidateTrafficLight::unsafe_arena_set_allocated_classification(
    ::osi3::TrafficLight_Classification* classification) {
...
inline void DetectedTrafficLight::unsafe_arena_set_allocated_header(
    ::osi3::DetectedItemHeader* header) {
  if (GetArenaForAllocation() == nullptr) {
...
inline void DetectedTrafficLight::unsafe_arena_set_allocated_base(
    ::osi3::BaseStationary* base) {
  if (GetArenaForAllocation() == nullptr) {
...
inline void DetectedTrafficLight::unsafe_arena_set_allocated_base_rmse(
    ::osi3::BaseStationary* base_rmse) {
  if (GetArenaForAllocation() == nullptr) {
...
inline ::osi3::DetectedTrafficLight_CandidateTrafficLight* DetectedTrafficLight::add_candidate() {
  ::osi3::DetectedTrafficLight_CandidateTrafficLight* _add = _internal_add_candidate();
...
inline void DetectedTrafficLight::unsafe_arena_set_allocated_color_description(
    ::osi3::ColorDescription* color_description) {
  if (GetArenaForAllocation() == nullptr) {
