...
class Occupant_Classification final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR Occupant_Classification(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  Occupant_Classification* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const Occupant_Classification& from) {
    Occupant_Classification::MergeImpl(*this, from);
  }
  private:
...
class Occupant final :
 ...
 public:
  ...
  ~Occupant() override;
  explicit PROTOBUF_CONSTEXPR Occupant(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  Occupant* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
